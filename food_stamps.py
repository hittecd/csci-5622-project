...
INSERT_FOOD_STAMPS_TEMPLATE = "INSERT INTO food_stamps (zip_id, recipient_count) VALUES ({0}, {1});"
DELETE_FOOD_STAMPS_TEMPLATE = "DELETE FROM food_stamps;"
...
class FoodStampsDAO:
    ...
    def delete_data():
        ...
        # delete food stamps records
        cursor.execute(DELETE_FOOD_STAMPS_TEMPLATE.format())
    ...
    def insert_data(self):
        # open file
        data_file = open("data/demographic/food_stamps.csv", "r")
        ...
        for data_line in data_lines[2:]:
            ...
            # get food stamp data if zip is in LA list
            food_stamps_data = data_line[FOOD_STAMPS_INDEX]
            ...
            cursor.execute(INSERT_FOOD_STAMPS_TEMPLATE.format(zip_code.zip_id, int(food_stamps_data)))
