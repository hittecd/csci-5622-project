...
from inventory_measure import InventorMeasureDAO;
...
if __name__ == "__main__":
    ...
    inventory_measure_dao = InventorMeasureDAO(state_dao, county_dao, metro_dao, city_dao, zip_dao)
    ...
    inventory_measure_dao.delete_data()
    ...
    inventory_measure_dao.insert_data()
