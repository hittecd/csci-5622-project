...
ZIP_INDEX = 2
FAMILY_HOUSEHOLDS_INDEX = 5
NONFAMILY_HOUSEHOLDS_INDEX = 25

INSERT_RELATIONSHIPS_TEMPLATE = "INSERT INTO relationships (zip_id, family_households, nonfamily_households) VALUES ({0}, {1}, {2});"
DELETE_RELATIONSHIPS_TEMPLATE = "DELETE FROM relationships;"
...
class RelationshipsDAO:
    ...
    def delete_data():
        ...
        cursor.execute(DELETE_RELATIONSHIPS_TEMPLATE.format())
    ...
    def insert_data(self):
        # open file
        data_file = open("data/demographic/relationships.csv", "r")
        ...
        for data_line in data_lines[2:]:
            ...
            family_households_data = data_line[FAMILY_HOUSEHOLDS_INDEX]
            nonfamily_households_data = data_line[NONFAMILY_HOUSEHOLDS_INDEX]
            ...
            cursor.execute(INSERT_RELATIONSHIPS_TEMPLATE.format(zip_code.zip_id,
                                                                int(family_households_data),
                                                                int(nonfamily_households_data)))
