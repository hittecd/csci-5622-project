...
ZIP_INDEX = 2
MEDIAN_INCOME_INDEX = 3

INSERT_MEDIAN_INCOME_TEMPLATE = "INSERT INTO median_income (zip_id, median_income) VALUES ({0}, {1});"
DELETE_MEDIAN_INCOME_TEMPLATE = "DELETE FROM median_income;"
...
class MedianIncomeDAO:
    ...
    def delete_data():
        ...
        # delete median income records
        cursor.execute(DELETE_MEDIAN_INCOME_TEMPLATE.format())
