...
MEDIAN_LISTING_PRICE_PER_SQFT_ALL_HOMES_TABLE = "median_listing_price_per_sqft_all_homes"
MEDIAN_LISTING_PRICE_PER_SQFT_CONDO_TABLE = "median_listing_price_per_sqft_condo"
MEDIAN_LISTING_PRICE_PER_SQFT_DUPLEX_TRIPLEX_TABLE = "median_listing_price_per_sqft_duplex_triplex"
MEDIAN_LISTING_PRICE_PER_SQFT_SFR_TABLE = "median_listing_price_per_sqft_sfr"
...
COUNTY_NAME_INDEX = 4
SIZE_RANK_INDEX = 5
MEDIAN_LISTING_PRICE_PER_SQFT_DATA_MIN_INDEX = 6
...
class MedianListingPricePerSqftHomeTypeDAO:
    @staticmethod
    def delete_data():
        ...
        cursor.execute(DELETE_MEDIAN_LISTING_PRICE_TEMPLATE.format(MEDIAN_LISTING_PRICE_PER_SQFT_ALL_HOMES_TABLE))
        cursor.execute(DELETE_MEDIAN_LISTING_PRICE_TEMPLATE.format(MEDIAN_LISTING_PRICE_PER_SQFT_CONDO_TABLE))
        cursor.execute(DELETE_MEDIAN_LISTING_PRICE_TEMPLATE.format(MEDIAN_LISTING_PRICE_PER_SQFT_DUPLEX_TRIPLEX_TABLE))
        cursor.execute(DELETE_MEDIAN_LISTING_PRICE_TEMPLATE.format(MEDIAN_LISTING_PRICE_PER_SQFT_SFR_TABLE))
    ...
    def insert_median_listing_price_per_sqft_data(self, table, data_file):
        ...
        date_fields = data_lines[0].replace('\"', '').split(',')[MEDIAN_LISTING_PRICE_PER_SQFT_DATA_MIN_INDEX:]
        ...
        for data_line in data_lines[1:]:
            ...
            median_listing_price_data = \
                data_line[MEDIAN_LISTING_PRICE_PER_SQFT_DATA_MIN_INDEX:]
    ...
    def insert_data(self):
        ...
        self.insert_median_listing_price_per_sqft_all_homes_data()

        self.insert_median_listing_price_per_sqft_condo_data()

        self.insert_median_listing_price_per_sqft_duplex_triplex_data()

        self.insert_median_listing_price_per_sqft_sfr_data()
