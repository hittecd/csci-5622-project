...
ZIP_INDEX = 2
PERSONAL_VEHICLE_INDEX = 7
CARPOOL_INDEX = 9
PUBLIC_TRANSPORT_INDEX = 21
TAXI_INDEX = 33
MOTORCYCLE_INDEX = 35
BICYCLE_INDEX = 37
WALKING_INDEX = 39

INSERT_TRANSPORTATION_METHOD_TEMPLATE = "INSERT INTO transportation_method (zip_id, personal_vehicle, carpool, public_transportation, taxi, motorcycle, walking, bicycle) VALUES ({0}, {1}, {2}, {3}, {4}, {5}, {6}, {7});"
DELETE_TRANSPORTATION_METHOD_TEMPLATE = "DELETE FROM transportation_method;"
...
class TransportationMethodDAO:
    ...
    def delete_data():
        ...
        # delete transportation method records
        cursor.execute(DELETE_TRANSPORTATION_METHOD_TEMPLATE.format())
