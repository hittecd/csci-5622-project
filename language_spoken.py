...
ZIP_INDEX = 2
ENGLISH_ONLY_INDEX = 7
NON_ENGLISH_INDEX = 11

INSERT_LANGUAGE_SPOKEN_TEMPLATE = "INSERT INTO language_spoken (zip_id, english_only, non_english) VALUES ({0}, {1}, {2});"
DELETE_LANGUAGE_SPOKEN_TEMPLATE = "DELETE FROM language_spoken;"
...
class LanguageSpokenDAO:
    ...
    def delete_data():
        ...
        # delete language spoken records
        cursor.execute(DELETE_LANGUAGE_SPOKEN_TEMPLATE.format())
    ...
    def insert_data(self):
        # open file
        data_file = open("data/demographic/language_spoken.csv", "r")
        ...
        for data_line in data_lines[2:]:
            ...
            # get language spoken data if zip is in LA list
            english_only_data = data_line[ENGLISH_ONLY_INDEX]
            non_english_data = data_line[NON_ENGLISH_INDEX]
            ...
            # insert language spoken records
            cursor.execute(INSERT_LANGUAGE_SPOKEN_TEMPLATE.format(zip_code.zip_id,
                                                                  int(english_only_data),
                                                                  int(non_english_data)))
