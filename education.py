...
ZIP_INDEX = 2
LESS_THAN_HS_INDEX = 4
BACHELORS_INDEX = 11
MASTERS_INDEX = 13

INSERT_EDUCATION_TEMPLATE = "INSERT INTO education (zip_id, less_than_high_school, bachelors, masters) VALUES ({0}, {1}, {2}, {3});"
DELETE_EDUCATION_TEMPLATE = "DELETE FROM education;"
...
class EducationDAO:
    ...
    def delete_data():
        ...
        cursor.execute(DELETE_EDUCATION_TEMPLATE.format())
    ...
    def insert_data(self):
        # open file
        data_file = open("data/demographic/education.csv", "r")
        ...
        for data_line in data_lines[2:]:
            ...
            # get education data if zip is in LA list
            less_than_hs_data = data_line[LESS_THAN_HS_INDEX]
            bachelors_data = data_line[BACHELORS_INDEX]
            masters_data = data_line[MASTERS_INDEX]
            ...
            cursor.execute(INSERT_EDUCATION_TEMPLATE.format(zip_code.zip_id,
                                                            int(less_than_hs_data),
                                                            int(bachelors_data),
                                                            int(masters_data)))
