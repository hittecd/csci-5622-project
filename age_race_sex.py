...
INSERT_AGE_RACE_SEX_TEMPLATE = "INSERT INTO age_race_sex (zip_id, male, female, percent_white, percent_black, percent_asian) VALUES ({0}, {1}, {2}, {3}, {4}, {5});"
DELETE_AGE_RACE_SEX_TEMPLATE = "DELETE FROM age_race_sex;"
...
class AgeRaceSexDAO:
    ...
    def delete_data():
        ...
        # delete age/race/sex records
        cursor.execute(DELETE_AGE_RACE_SEX_TEMPLATE.format())
    ...
    def insert_data(self):
        ...
        for data_line in data_lines[2:]:
            ...
            if(men_data == '' or women_data == '' or percent_white_data == '' or percent_black_data == '' or percent_asian_data == ''):
                continue;
            ...
            cursor.execute(INSERT_AGE_RACE_SEX_TEMPLATE.format(zip_code.zip_id,
                                                               int(men_data),
                                                               int(women_data),
